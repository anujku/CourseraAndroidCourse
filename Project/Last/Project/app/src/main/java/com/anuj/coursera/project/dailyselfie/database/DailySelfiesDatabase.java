package com.anuj.coursera.project.dailyselfie.database;
...
public class DailySelfiesDatabase
{
    ...
    private static final String DATABASE_TABLE = "daily_selfies";
    private static final int DATABASE_VERSION = 1;

    private static final String DATABASE_CREATE = "create table daily_selfies (_id integer primary key autoincrement, "
    ...
    public DailySelfiesDatabase(Context ctx) {
        mContext = ctx;
    ...
    private static class DatabaseHelper extends SQLiteOpenHelper
    {
        ...
        public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
            db.execSQL("DROP TABLE IF EXISTS daily_selfies");
            onCreate(db);
        }
    }
}
