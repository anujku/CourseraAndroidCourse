package com.anuj.coursera.project.dailyselfie.activities;
...
import com.anuj.coursera.project.dailyselfie.broadcastrecievers.DailySelfiesAlarmReceiver;
import com.anuj.coursera.project.dailyselfie.fragments.DailySelfiesFragment;
...
public class DailySelfiesActivity extends Activity {

    private PendingIntent pendingIntent;
    private DailySelfiesFragment mSelfiesFragment;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.daily_activity_selfies);

        mSelfiesFragment = new DailySelfiesFragment();
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.daily_selfies, menu);
        return true;
    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (requestCode == REQUEST_IMAGE_CAPTURE && resultCode == RESULT_OK) {
            ...
            DailySelfieRecord newSelfie = new DailySelfieRecord(selfieName, null);
            newSelfie.setPictureBitmap(DailySelfiesPictureHelper.getTempBitmap(this));
    ...
    private void setupAlarm() {
        ...
        Intent alarmIntent = new Intent(this, DailySelfiesAlarmReceiver.class);
    ...
    private void dispatchTakePictureIntent() {
        ...
        takePictureIntent.putExtra(MediaStore.EXTRA_OUTPUT, Uri.fromFile(DailySelfiesPictureHelper.getTempFile(this)));
